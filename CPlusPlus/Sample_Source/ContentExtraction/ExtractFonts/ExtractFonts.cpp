...
DURING
    ...
    PDDocEnumResources (pdDoc, 0, PDDocGetNumPages(pdDoc) - 1, ASAtomFromString ("Font"), ExtractEmbeddedFonts, NULL);
HANDLER
        ...
        else
        {
            ...
            else
            {
                if (CosDictKnown (descriptor, ASAtomFromString ("FontFile3")))
                {
                    ...
                    if ((subType == ASAtomFromString ("Type1C")) ||
                        (subType == ASAtomFromString ("Type1")) ||
