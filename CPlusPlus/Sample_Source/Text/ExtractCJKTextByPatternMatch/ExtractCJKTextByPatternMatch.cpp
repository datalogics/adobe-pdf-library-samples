...
//
// For more detail see the description of the ExtractCJKTextByPatternMatch sample program on our Developer’s site,
...
const char *DEF_INPUT = "../../../../Resources/Sample_Input/ExtractUnicodeText.pdf";
const char *DEF_OUTPUT = "ExtractCJKTextByPatternMatch-out.txt";

// This sample will look for text that matches a Korean phrase
const char *DEF_PATTERN = regexPattern[KOREAN_PATTERN];
