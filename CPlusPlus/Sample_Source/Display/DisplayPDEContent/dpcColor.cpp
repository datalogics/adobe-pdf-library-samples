       ...
       case CColorSpaces::RGB_cs:
        ...
        case CColorSpaces::CMYK_cs:
                 ...
                 (Color->value.color[2] == Color->value.color[3]))
            {
                ...
                if ((Color->value.color[0] == 0) && 
                    (Color->value.color[3] == 0))
                {
                    oss << " CMYK - White";
                    break;
                }
                if ((Color->value.color[0] == 0) && 
                    (Color->value.color[3] == fixedOne))
                {
                    oss << " CMYK - True Black";
                    break;
                }
        ...
        case CColorSpaces::Index_cs:
        {
            ...
            oss << " Indexed Color space of " << IndexRange + 1 << " Value in " << BaseColorInfo.m_name.c_str() << ". Value " << Color->value.color[0] << " (";
