...
void    ASDoubleIdentity (ASDoubleMatrix *out) {out->a = out->d = 1.0; out->b = out->c = out->h = out->v = 0;}
...
void    ASDoubleToRealMatrix (ASRealMatrix *out, ASDoubleMatrix *in) {out->a = (ASReal)in->a; out->b = (ASReal)in->b;out->c = (ASReal)in->c; out->d = (ASReal)in->d;out->tx = (ASReal)in->h; out->ty = (ASReal)in->v;}
