...
//    join the (x, y) coordinates with straight lines.
        ...
        ASInt32 arrowXCoordinates[numberOfPoints] = 
            {(72 * 7), (72 * 6), (72 * 6), (72 * 4), (72 * 4), (72 * 3), (72 * 5)};
        ASInt32 arrowYCoordinates[numberOfPoints] = 
            {(72 * 7), (72 * 7), (72 * 3), (72 * 3), (72 * 7), (72 * 7), (72 * 9)};
        ...
        PDEPathAddSegment(pdePath, kPDEMoveTo, pointToInsert.h, pointToInsert.v,
        ...
        for (unsigned i = 0; i < numberOfPoints; ++i)
        {
            ...
            PDEPathAddSegment(pdePath, kPDELineTo, pointToInsert.h, pointToInsert.v,
                              fixedZero, fixedZero, fixedZero, fixedZero);
        }
...
//   http://www.adobe.com/content/dam/Adobe/en/devnet/acrobat/pdfs/PDF32000_2008.pdf#page=122
        ...
        pointToInsert.h = ASInt32ToFixed(72 * 5);
        pointToInsert.v = ASInt32ToFixed(72 * 9);
        PDEPathAddSegment(pdePath2, kPDEMoveTo, pointToInsert.h, pointToInsert.v,
                          fixedZero, fixedZero, fixedZero, fixedZero);
        ...
        for (unsigned i = 0; i < numberOfPoints; ++i)
        {
            ...
            PDEPathAddSegment(pdePath2, kPDELineTo, pointToInsert.h,
                              pointToInsert.v, fixedZero, fixedZero, fixedZero, fixedZero);
        }
