...
// 1) Create the first PDFileAttachment.
        ...
        PDFileAttachment attach1PDFA = PDFileAttachmentNewFromFile ( 
                inputDocCD,        //The PDF the file attachment will be referenced from.
...
// 4) Create an annotation.
        ...
        PDAnnot newAnnot = PDPageCreateAnnot ( 
            page1,                                 //The page the annotation will go on.
