...
int main(int argc, char *argv[])
{
    ...
    std::cout << "Adding bookmarks to " << csInputFileName.c_str() << ", writing to " << csOutputFileName.c_str() << std::endl;
...
DURING
    ...
    unsigned char korTitle[] = {0xFE, 0xFF, 0xB3, 0x00, 0xD5, 0x5C, 0xBB, 0xFC, 0xAD, 0x6D, 0x00, 0x00};
    ...
    PDViewDestination destParent = PDViewDestCreate(pdDoc1, dstPageParent, fitType, &destRect, zoom, dstPageNumParent);
