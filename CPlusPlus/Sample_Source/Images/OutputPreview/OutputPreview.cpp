...
void WriteDeviceNImage (PageInfo *pageInfo, PDDoc outputDoc)
{
    ...
    AddImageToDoc (pageInfo, outputDoc, pageInfo->deviceNspace, pageInfo->drawParams.buffer, pageInfo->drawParams.bufferSize, pageInfo->numberOfColorants, "Composite DeviceN", "All colorants");
    ...
    AddImageToDoc (pageInfo, outputDoc, ModifiedSpace, pageInfo->drawParams.buffer, pageInfo->drawParams.bufferSize, pageInfo->numberOfColorants, "Composite DeviceN", "Only Process Colorants");
    ...
    AddImageToDoc (pageInfo, outputDoc, ModifiedSpace, pageInfo->drawParams.buffer, pageInfo->drawParams.bufferSize, pageInfo->numberOfColorants, "Composite DeviceN", "Only Spot Colorants");
    PDERelease ((PDEObject)ModifiedSpace);
...
void AddImageToDoc (PageInfo *pageInfo, PDDoc outputDoc, PDEColorSpace space, char *buffer, size_t bufferSize, ASInt16 channels, char *Name, char *Info)
{
    ...
    if (Info != NULL)
        PDETextAddEx (text, kPDETextRun, 1, (ASUns8 *)Info, strlen (Info), pageInfo->textFont,
            &pageInfo->textGState, sizeof (PDEGraphicState),
            &pageInfo->textTState, sizeof (PDETextState), &pageInfo->secondaryTextMatrix, NULL);
...
PDEColorSpace CreateSpotColorSpace (PageInfo *pageInfo, PDPageInk ink)
{
    ...
    char baseTransformText[] = "{dup %1.5g mul exch dup %1.5g mul exch dup %1.5g mul exch %1.5g mul}";
